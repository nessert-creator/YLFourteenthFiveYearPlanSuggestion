...
class ImageUpload extends React.Component {
    constructor() {
        ...
        this.handlePreviewCancel = () => this.setState({ previewVisible: false });
        this.handlePreviewShow = () => {
            this.setState({
                previewVisible: true
            });
        };
        this.handleImageBrowseCancel = () => this.setState({ imageBrowseVisible: false });
        this.handleImageBrowseShow = () => {
            this.setState({
                imageBrowseVisible: true
            });
        };
        this.handleImageBrowseChange = (imageUrl) => {
            this.setState({
                imageBrowseVisible: false,
                isHover: false
            });
    ...
    render() {
        ...
        return (<div>
				<div>
					{previewImage ? (<img onMouseEnter={this.onMouseEnter} src={remoteUrl + previewImage} style={{
            width: '130px',
            height: '130px'
        }}/>) : (<div style={{
            width: '130px',
            ...
            cursor: 'pointer'
								...
								{this.props.serverUploadVisible && (<Icon style={{
            fontSize: 30,
            color: '#c6c8cb',
            cursor: 'pointer',
            marginLeft: '12px'
        }} type="cloud-upload-o" onClick={this.handleImageBrowseShow}/>)}
							</center>
						</div>)}
				</div>
				<div onMouseLeave={this.onMouseLeave} style={{
            position: 'absolute',
            width: '130px',
            height: '130px',
            lineHeight: '145px',
            ...
            cursor: 'pointer',
            marginRight: '12px'
        }} type="eye-o" onClick={this.handlePreviewShow}/>
						<Upload {...props}>
							<Icon style={{
            fontSize: 30,
            color: 'rgba(255, 255, 255, 0.85)',
            ...
            marginLeft: '12px'
				...
				<ServerImageBrowse onChange={this.handleImageBrowseChange} visible={this.state.imageBrowseVisible} onCancel={this.handleImageBrowseCancel}/>
			</div>);
    }
}
