...
function AddRoleModal({ dispatch, form, addRoleModalState, permissionTree, selectRoles }) {
    function handleCancel() {
        dispatch({
            type: 'role/setState',
            payload: {
                addRoleModalState: Object.assign({}, addRoleModalState, { visible: false })
            }
        });
    }
    ...
    function onTabChange(value) {
        dispatch({
            type: 'role/setState',
            payload: { addRoleModalState: Object.assign({}, addRoleModalState, { activeTabKey: value }) }
        });
    }
    return (<Modal visible={addRoleModalState.visible} title="添加角色" onCancel={handleCancel} footer={[
