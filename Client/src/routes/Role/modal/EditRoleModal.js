...
import { Modal, Form, Input, Button, Tabs, Checkbox, Tree } from 'antd';
 ...
 * 描述: 添加角色弹窗
 */
function EditRoleModal({ dispatch, form, editRoleModalState, permissionTree, selectRoles, editingRole, isInitializingModal }) {
    function handleCancel() {
        dispatch({
            type: 'role/setState',
            payload: {
                editRoleModalState: Object.assign({}, editRoleModalState, { visible: false })
            }
        });
    }
    ...
    function onTabChange(value) {
        dispatch({
            type: 'role/setState',
            payload: {
                editRoleModalState: Object.assign({}, editRoleModalState, { activeTabKey: value })
            }
        });
    }
    return (<Modal visible={editRoleModalState.visible} title="修改角色" onCancel={handleCancel} footer={[
