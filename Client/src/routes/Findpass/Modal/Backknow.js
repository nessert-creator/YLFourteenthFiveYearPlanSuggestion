...
function Backkonw({ dispatch, form, loading, hedhtml, abled }) {
    ...
    return (<div>
      ...
      <Form className={`${styles.formbox} login-form`}>
    ...
    })(<Input prefix={<Icon type="layout" style={{ fontSize: 13 }}/>} placeholder="请输入邮箱地址" style={{ marginTop: '5px', height: 40 }}/>)}
        </FormItem>
        <FormItem>
        ...
        rules: [{ required: true, message: '请输入邮箱验证码！' }],
              ...
              <Input prefix={<Icon type="exception" style={{ fontSize: 13 }}/>} placeholder="邮箱验证码" style={{ width: '230px', float: 'left', height: 40 }}/>
...
Backkonw = connect((state) => {
    return Object.assign({}, state.backknow, { loading: state.loading.effects['backknow/sentpass2'] });
})(Backkonw);
