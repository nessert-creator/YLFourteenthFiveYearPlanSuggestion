...
function Chatsearch({ dispatch, openSearchFriend, searchfriends, addselect, friendPagination }) {
    ...
    return (<Modal title="好友查找" visible={openSearchFriend} onOk={handleOkSearchFriend} width={600} onCancel={handleCancel8}>
      <Table rowSelection={rowSelection} columns={columns} dataSource={searchfriends.items} pagination={friendPagination} onChange={handleTableChange}/>
    </Modal>);
}
