...
const Echartall = React.createClass({
    ...
    render() {
        return (<div>
        <Row>
          <Col xl={11} lg={24} style={{ background: '#fff', marginTop: 20 }}><Chart data={this.state.data} width={this.state.width} height={this.state.height} plotCfg={this.state.plotCfg} forceFit={this.state.forceFit}/></Col>
          <Col xl={{ span: 11, offset: 1 }} lg={24} style={{ background: '#fff', marginTop: 20 }}><Chart2 data={this.state.data2} width={this.state.width} height={this.state.height} plotCfg={this.state.plotCfg} forceFit={this.state.forceFit}/></Col>
          <Col xl={11} lg={24} style={{ background: '#fff', marginTop: 20 }}> <Chart3 data={this.state.data3} width={this.state.width} height={this.state.height} forceFit={this.state.forceFit}/></Col>

          {this.state.data.length === 0 ? <div></div> :
            <Col xl={{ span: 11, offset: 1 }} lg={24} style={{ background: '#fff', marginTop: 20 }}> <Chart4 data={this.state.data4} width={this.state.width} height={this.state.height} forceFit={this.state.forceFit}/></Col>}
        </Row>
      </div>);
    },
});
