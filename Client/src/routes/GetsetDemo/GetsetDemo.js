...
function GetsetDemo({ form, data }) {
    ...
    return (<GetSet form={form} getApi={new api.FileSettingDemoApi().appFileSettingDemoGet} setApi={new api.FileSettingDemoApi().appFileSettingDemoSet} formNode={formNode}/>);
}
