...
function Topic({ form, record }) {
    ...
    return (<CRUD form={form} getAllApi={new api.TopicApi().appTopicGetAll} deleteApi={new api.TopicApi().appTopicDelete} updateApi={new api.TopicApi().appTopicUpdate} createApi={new api.TopicApi().appTopicCreate} columns={columns} formNode={formNode} filterProps={{
        filters,
        searchProvide: 'sql'
    }}/>);
}
