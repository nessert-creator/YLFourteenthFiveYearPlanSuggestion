 ...
 * 描述: 编辑组织机构弹窗
 */
function EditOrganizationModal({ dispatch, form, editOrganizationModalVisible, organization, parentId, editOrganizationId, isAddOrganization }) {
    ...
    return (<Modal visible={editOrganizationModalVisible} width={658} title={isAddOrganization ? '添加组织机构' : '编辑组织机构'} onCancel={handleCancel} footer={[
