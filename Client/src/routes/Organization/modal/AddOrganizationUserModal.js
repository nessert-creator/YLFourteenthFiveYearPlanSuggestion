 ...
 * 描述: 添加组织机构成员弹窗
 */
function AddOrganizationUserModal({ dispatch, addOrganizationUserModalVisible, organization, validUserList, selectedUsers, validUserPagination, validUserLoading, validUserNameFilter }) {
    ...
    return (<Modal visible={addOrganizationUserModalVisible} width={658} title="添加成员" onCancel={handleCancel} footer={[
        ...
        <Button key="submit" onClick={handleCancel}>
			...
			<Table columns={columns} rowSelection={rowSelection} pagination={validUserPagination} rowKey={(user) => user.id} dataSource={validUserList.items} onChange={handleTableChange} loading={validUserLoading}/>
		</Modal>);
}
