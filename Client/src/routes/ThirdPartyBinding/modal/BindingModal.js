...
function BindingModal({ dispatch, bindingModalVisible, form, thirdPartyToken }) {
    ...
    return (<Modal visible={bindingModalVisible} width={658} title="绑定账号" onCancel={handleCancel} footer={[
...
BindingModal = connect((state) => {
    return Object.assign({}, state.thirdpartybinding, { thirdPartyToken: state.indexpage.thirdPartyToken });
})(BindingModal);
