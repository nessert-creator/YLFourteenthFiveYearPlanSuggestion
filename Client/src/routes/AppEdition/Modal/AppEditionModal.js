...
function AppEditionModal({ dispatch, form, modalVisible, modalText, isAdd, isIOS, record }) {
    ...
    return (<Modal visible={modalVisible} title={modalText} onCancel={handleCancel} footer={[
        ...
        initialValue: record.describe
				...
				{isIOS ? (<FormItem label="Itunes连接地址" {...formCol}>
...
AppEditionModal = connect((state) => {
    return Object.assign({}, state.appEdition);
})(AppEditionModal);
