...
function CustomColumnSelector({ dispatch, visibleColumnTitles, customColumnSelectorVisible }) {
    ...
    const customColumnSelector = (<div>
    ...
    return (<Popover content={customColumnSelector} title={selectorTitle} placement="bottomRight" visible={customColumnSelectorVisible} trigger="click" onVisibleChange={handleVisibleChange}>
