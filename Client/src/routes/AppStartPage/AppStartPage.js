...
function AppStartPage({ form, record }) {
    ...
    return (<CRUD form={form} getAllApi={new api.AppStartPageApi().appAppStartPageGetAll} deleteApi={new api.AppStartPageApi().appAppStartPageDelete} updateApi={new api.AppStartPageApi().appAppStartPageUpdate} createApi={new api.AppStartPageApi().appAppStartPageCreate} deleteBatchApi={new api.AppStartPageApi().appAppStartPageDeleteBatch} columns={columns} formNode={formNode} filterProps={{
        filters,
        searchProvide: 'sql'
    }}/>);
}
