...
function Register({ dispatch, form, captcha, abled, hedhtml, thirdPartyToken }) {
    ...
    })(<Input prefix={<Icon type="user" style={{ fontSize: 13 }}/>} placeholder="1-16个字符" style={{ marginTop: '5px', height: 40 }}/>)}
					</FormItem>
					<FormItem>
...
Register = connect((state) => {
    return Object.assign({}, state.register, { thirdPartyToken: state.indexpage.thirdPartyToken });
})(Register);
