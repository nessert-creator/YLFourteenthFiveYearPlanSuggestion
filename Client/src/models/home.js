...
export default {
    ...
    reducers: {
        ...
        setTitle(state, { payload }) {
            ...
            return Object.assign({}, state, { title: title, pathname: pathname, menus: menus });
        },
        setMybbtodoState(state, { payload }) {
            return Object.assign({}, state, { mybbtodo: [...state.mybbtodo, ...payload] });
        },
            ...
            if (state.friends) {
                let newfriends = state.friends.friends.map((ele) => {
                    if (ele.friendUserId == payload.message.targetUserId && payload.message.readState == 1) {
                        return Object.assign({}, ele, { badge: payload.shownew });
                    }
                    else {
                        return ele;
                    }
                });
                return Object.assign({}, state, { friends: Object.assign({}, state.friends, { friends: [...newfriends] }) });
            }
        },
        ...
        setNotificationSettingsState(state, { payload }) {
            return Object.assign({}, state, { notificationSettings: Object.assign({}, state.notificationSettings, payload) });
        },
        pushRealtimeNotification(state, { payload }) {
            ...
            return Object.assign({}, state, { notification: Object.assign({}, state.notification, { unreadCount: state.notification.unreadCount + 1, items: notifications }) });
        }
    },
    effects: {
        ...
        *getUserNotifications({ payload }, { call, put }) {
            ...
            if (success) {
                yield put({
                    type: 'setState',
                    payload: {
                        notification: Object.assign({}, result)
                    }
                });
            }
        },
        ...
        *getNotificationSettings({ payload }, { call, put }) {
            ...
            if (success) {
                yield put({
                    type: 'setState',
                    payload: {
                        notificationSettings: Object.assign({}, result)
                    }
                });
            }
        },
