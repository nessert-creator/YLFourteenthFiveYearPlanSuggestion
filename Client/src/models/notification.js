        ...
        *getUserNotifications({ payload }, { call, put }) {
            ...
            if (success) {
                yield put({
                    ...
                    payload: {
                        items: result.items,
                        pagination: Object.assign({}, payload, { total: result.totalCount, current: payload.current, pageSize: payload.pageSize })
                    }
                });
            }
        },
        *setNotificationAsRead({ payload }, { call, put, select }) {
            ...
            if (success) {
                ...
                yield put({
                    ...
                    payload: Object.assign({}, (yield select(({ notification }) => notification.pagination)))
                });
            }
        }
    },
