...
namespace QC.MF.EntityFramework
{
    public class MFDbContext : AbpZeroDbContext<Tenant, Role, User>
    {
        ...
        public IDbSet<Notice.Notice> Notice { get; set; }
        public IDbSet<Message.Message> Message { get; set; }
        public IDbSet<Messager.Messager> Messager { get; set; }
        public IDbSet<Topic.Topic> Topic { get; set; }
