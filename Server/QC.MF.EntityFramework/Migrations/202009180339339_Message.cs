    ...
    public partial class Message : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                annotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_Messager_SoftDelete", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                })
                .PrimaryKey(t => t.Id);
            ...
            CreateTable(
                ...
                annotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_Notice_SoftDelete", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                })
                .PrimaryKey(t => t.Id);
